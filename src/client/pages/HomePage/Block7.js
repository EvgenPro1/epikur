                ...
                <div className={'block__7__container'}>
                    {product.map( (m, index) => (
                        <div className={'card__container'} key={index}>
                            ...
                            <div className={'card__text__block__7 Formular-Light'}>{m.text2}</div>
                ...
                >
                    {product.map( (m, index) => (
                        ...
                        <div className={'card__container__swiper'} >
                            <div className={' card__img__container'} style={{animation: '5s card__img__container ' + index * 0.5 + 's ease-in-out infinite'}}>
                                <img src={m.img} alt="" className={'card__img card__img__swiper'}/>
                            </div>
                            <div className={'card__header card__header__swiper Bebas-Neue-Bold'}>{m.header}</div>
                            <div className={"card__text__container__swiper"}>
                                <div className={'card__text__block__7  Formular-Light'}>{m.text1}</div>
                                <img src={m.img2} alt="" className={'card__img2'}/>
                                <div className={'card__text__block__7 Formular-Light'}>{m.text2}</div>
                            </div>
