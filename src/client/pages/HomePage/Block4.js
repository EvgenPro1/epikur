    ...
    return (
        <div className={'block__4__container'}>
            ...
            <div className={'block__4__img4__container'}>
                <ParallaxProvider>
                    <Parallax
                        y={[-5, 5]} tagOuter="figure"
                        slowerScrollRate
                        tag="figure">
                        <img src={chickencontur1} alt="egg1" className={'block__4__img4'}/>
                    </Parallax>
                </ParallaxProvider>
            </div>
            ...
            <div className={'block__4__text__container'}>
                <Row >
                    <Col md={6} className={'display__flex__center'}>
                        <div className={'block__4__header Bebas-Neue-Bold'}>COMPANY EPIKUR</div>
                    </Col>
                    <Col md={6} className={'display__flex__center'}>
